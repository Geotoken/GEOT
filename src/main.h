...
static const int64 MAX_MONEY = 1000000 * COIN; // Geotoken: maximum of 1M coins 
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 2880 / 250; // Geotoken: 2880 blocks found a day. Priority cutoff is 1 geotoken day / 250 bytes.
    }
