...
uint256 hashGenesisBlock("0x00000164a852a3a779ff78a966e1a80c2e4efbf8bc8d8c690a813d36b7ca2061");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Geotoken: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Geotoken Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    nSubsidy >>= (nHeight / 20000);

	return nSubsidy + nFees;
}


static const int64 nTargetTimespan = 3 * 60;	// Geotoken: 3 mins 
static const int64 nTargetSpacing = 75;			// Geotoken: 75 sec
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal geotoken miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Geotoken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000164a852a3a779ff78a966e1a80c2e4efbf8bc8d8c690a813d36b7ca2061");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "In June 19, 1865, Union soldiers, led by Major General Gordon Granger, landed at Galveston, Texas with news that the war had ended and that the enslaved were now free. 1466328174.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x84a51ca613ed48b5105dce920db6c0ff4ddc731cc9b820588887e6961298c21e"));
...
unsigned char pchMessageStart[4] = { 0xa5, 0xfd, 0xb6, 0xc1 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // FeatherCoinClassicd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
